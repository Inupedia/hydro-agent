...
metadata:
  ...
  when_to_use_zh: "A04 已形成模型假设后|准备 A05 参数实验|Gate 后需要组织下一轮 XAJ 实验"
  required_evidence_zh: "hydro diagnosis|Campaign locks|当前基线|专业诊断 Skill 输出|上一轮 Gate"
  recommended_actions: "A04_DIAGNOSE|A05_OPTIMIZE|A06_GATE|A07_RESOLVE"
...
6. A06 在 development 数据上独立比较候选与当前基线；
7. A07 执行 ADOPT/KEEP/ROLLBACK；
8. 继续循环，直到 **Campaign 自身**给出 `stop_reason`；
9. A08 冻结后才允许 final-test/replay 和最终报告。
