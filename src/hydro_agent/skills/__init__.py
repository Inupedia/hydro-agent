...
HBV_DIAGNOSIS_SKILL_ID = "hbv-calibration-diagnosis"
TANK_DIAGNOSIS_SKILL_ID = "tank-calibration-diagnosis"
SAC_SMA_DIAGNOSIS_SKILL_ID = "sac-sma-calibration-diagnosis"
