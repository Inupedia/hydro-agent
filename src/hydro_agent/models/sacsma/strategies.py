...
from hydro_agent.models.sacsma.param_groups import FULL_PARAM_GROUPS
...
SAC_SMA_SCEUA_BENCHMARK_V1 = CalibrationStrategy(
    strategy_id="sac-sma-sceua-benchmark-v1",
    max_candidates=2048,
