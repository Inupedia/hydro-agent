"""Durable per-workspace state for resumable model calibration.
...
Model-agnostic: XAJ, GR4J, and future plugins share this layout so
``CalibrationService`` never imports a model package.
"""
